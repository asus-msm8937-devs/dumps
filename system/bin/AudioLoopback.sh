...
CODECLOOPBACK()
{
    ...
    if   [ "$2" == "3" ]; then                               #Speaker L
        /system/bin/tinymix 'RX3 MIX1 INP1' 'IIR1'
        /system/bin/tinymix 'SPK' 'Switch'
	...
	/system/bin/tinymix 'RX1 MIX1 INP1' 'IIR1'
        ...
        /system/bin/tinymix 'Loopback MCLK' 'ENABLE'
        logi "Headset"
    elif [ "$2" == "4" ]; then                               #Earpiece
        /system/bin/tinymix 'RX1 MIX1 INP1' 'IIR1'
        /system/bin/tinymix 'RX1 Digital Volume' '67'
